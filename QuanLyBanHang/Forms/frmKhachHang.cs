...
namespace QuanLyBanHang.Forms
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            if (dataGridView.CurrentRow != null && !btnLuu.Enabled) // Chỉ cập nhật khi không ở chế độ Thêm/Sửa
            {
                // Thường dùng DataBinding đã có ở Form_Load, 
                // nhưng nếu muốn chắc chắn lấy ID để Sửa/Xóa:
                var selectedId = dataGridView.CurrentRow.Cells["ID"].Value;
                if (selectedId != null)
                {
